      ...
      <ContentWrapper className={`relative`}>
        ...
        <>
          {data?.length > 0 && (
            <>
              {title && (
                <div className="text-2xl  mb-5 font-normal ">{title}</div>
              )}
        ...
        {!loading ? (
          // carousel items
          <div
            className="flex gap-3 md:gap-5 -mr-5 -ml-5 px-5 md:m-0 md:p-0 overflow-y-hidden xl:overflow-hidden rounded-2xl "
                ...
                >
                  ...
                  <div className="relative w-full aspect-[1/1.5] bg-cover bg-center mb-[30px] flex items-end justify-between p-[10px] ">
                    ...
                    <CircleRating
                      ...
                      className={
                        "relative w-10 h-10 top-[30px] md:w-[50px] md:h-[50px] bg-white shrink-0"
                      }
                      fillColor={"#04152d"}
                    />
                    ...
                    <Genres
                      ...
                      className={
                        "relative flex gap-[5px] flex-wrap justify-end"
                      }
                    />
                  </div>
