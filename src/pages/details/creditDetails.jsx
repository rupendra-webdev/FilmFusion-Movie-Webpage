...
const CreditDetails = () => {
  ...
  const imgUrl = creditdata?.person?.profile_path
    ? url?.profile + creditdata?.person?.profile_path
    : noAvatar;
      ...
      <ContentWrapper className={"relative flex justify-center items-center "}>
        {!loading ? (
          <div className="flex flex-col justify-center items-center ">
            ...
            {/* profile img */}
            <div
              className="relative w-[125px] sm:w-60 md:w-72 h-[125px] md:h-72 sm:h-60 rounded-full overflow-hidden mb-[15px] md:mb-[25px] 
                                shadow-[0px_2px_40px_0px_#f7fafc] "
            >
              <Img
                src={imgUrl}
                alt={`profile image of ${creditdata?.name}`}
            ...
            <div>
              <h3 className="text-3xl font-bold text-center ">
                {creditdata?.person?.name}🎬
              </h3>
              <h3 className="text-base text-neutral-500 font-bold text-center ">
                {creditdata?.media?.character}
              </h3>
            </div>
            ...
            <div className="mx-3 text-[12px] sm:text-[15px] md:text-[17px] p-2 md:p-4 mt-6 flex justify-between items-center bg-[#112241] rounded-full ">
              ...
              <div className="border-r-2 border-neutral-400 px-1 sm:px-3 md:px-4 flex flex-col items-center">
                ...
                <p className="text-neutral-300 text-sm">
                  {creditdata?.person?.gender === 1 ? "Female" : "Male"}
                </p>
              </div>
            ...
            <div className="my-6 mx-4 space-y-2 text-center">
              ...
              <p className="text-neutral-400 tracking-wide text-center">
                ...
                quas eligendi enim! Dignissimos dolorum unde recusandae
                accusantium numquam amet iure reprehenderit nesciunt mollitia
                quo, architecto porro, praesentium a laborum exercitationem
                velit, aut veritatis eligendi provident. Molestiae id facere
                voluptas architecto fugit pariatur sequi molestias iste nisi
                omnis vitae, dolor dolorum? Dolorum numquam sapiente veritatis
                perspiciatis necessitatibus nam voluptates voluptatibus nemo
                dignissimos. Est accusantium et illo molestias nulla veniam vel
                praesentium in, exercitationem aperiam magni esse assumenda
                asperiores totam provident ducimus laborum quaerat. Magni
                accusamus animi pariatur quisquam ducimus dolores quo maxime
                fugiat id porro sequi temporibus illum, praesentium assumenda
                quibusdam!
              </p>
            </div>
          </div>
