              ...
              <ContentWrapper>
                ...
                <div className="relative flex flex-col md:flex-row gap-[25px] md:gap-[50px] ">
                  ...
                  <div className="text-white ">
                    ...
                    <Genres
                      data={_genres}
                      className={"mb-[25px] flex gap-[5px] flex-wrap "}
                    />
